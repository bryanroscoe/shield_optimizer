...
or mutation, no speculative persistence, and no deployment. Accepted Navigator
work is committed and pushed under the September 10 policy in `AGENTS.md`.** This supersedes
...
work. This assignment permits no device attachment/mutation, deployment, or speculative
session persistence. The September 10 `AGENTS.md` policy requires accepted Navigator
workspace work to be committed and pushed. Earlier parallel-Opus/cloud-routine guidance
is historical and does not expand current authority.
